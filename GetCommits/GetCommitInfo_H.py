...
def main():
    ...
    # For WINDOWS 
    REPO_CSV = 'C:\\Users\kmpoo\Dropbox\HEC\\2014GithubRepoData_Latest\FullData_20190604IVT_COLAB_398-500.csv'
#    NEWREPO_CSV = 'C:\\Data\\092019 CommitInfo\\RepoCommit_1.csv'
    NEWREPO_xl = 'C:\\Data\\092019 CommitInfo\\RepoCommit500_1.xlsx'
...
#            appendrowincsv(NEWREPO_CSV, repo_row)
            ...
            if rcount == 500:
                rcount = 1
                sheetno = sheetno + 1
                NEWREPO_xl = 'C:\\Data\092019 CommitInfo\RepoCommit500_'+str(sheetno)+'.xlsx'
            rcount = rcount + 1
