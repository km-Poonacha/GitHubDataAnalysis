...
COMMIT_EMPTY = r"C:\Users\pmedappa\Dropbox\Data\092019 CommitInfo\Organization_Specific\ibm\ibm_EMPTY.xlsx"
...
for index in file_i:
    COMMIT_XL = r"C:\Users\pmedappa\Dropbox\Data\092019 CommitInfo\Organization_Specific\ibm\ibm_commit_"+str(index)+".xlsx"
    print(COMMIT_XL)    
