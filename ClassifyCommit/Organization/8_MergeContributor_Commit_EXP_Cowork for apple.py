...
def mergefiles():
    ...
    for i in [1,'EMPTY']:
        commit = r'C:\Users\pmedappa\Dropbox\Data\092019 CommitInfo\Organization_Specific\apple\Classified\new2_classified_apple_commit_'+str(i)+'.xlsx'
        temp_df = pd.read_excel(commit,header= 0)
        commit_df = commit_df.append(temp_df, ignore_index=True)

    contri = r'C:\Users\pmedappa\Dropbox\Data\092019 CommitInfo\Organization_Specific\apple\Classified\Experience\month_coexp_exp_int2_org_col_classified_apple_commit_full.xlsx'
    print(commit,"  ", contri)
...
def dataprep(write_df):
    ...
    write_df[['org_createdAt','org_login','org_name','org_twitterUsername','releases_nodes','releases_nodes_0_author','releases_nodes_0_createdAt',
     ...
     'repo_description','repo_diskUsage','repo_forkCount','repo_id','repo_isArchived','repo_isFork','repo_isMirror',
     'repo_isTemplate','repo_languages_nodes','repo_languages_totalCount','repo_licenseInfo_name',
     'repo_licenseInfo_pseudoLicense','repo_owner_login','repo_pushedAt','repo_stargazerCount','repo_updatedAt',
     'first_release']]  =  write_df[['org_createdAt','org_login','org_name','org_twitterUsername','releases_nodes','releases_nodes_0_author','releases_nodes_0_createdAt',
     'releases_nodes_0_description','releases_nodes_0_isLatest',
     'releases_nodes_0_name','releases_nodes_0_publishedAt','releases_nodes_0_updatedAt','releases_totalCount','repo_createdAt',
     'repo_description','repo_diskUsage','repo_forkCount','repo_id','repo_isArchived','repo_isFork','repo_isMirror',
     'repo_isTemplate','repo_languages_nodes','repo_languages_totalCount','repo_licenseInfo_name',
     'repo_licenseInfo_pseudoLicense','repo_owner_login','repo_pushedAt','repo_stargazerCount','repo_updatedAt',
     'first_release']].fillna(method='ffill')
...
def main():
    ...
    merged_file = r'C:\Users\pmedappa\Dropbox\Data\092019 CommitInfo\Organization_Specific\Merged\merge_month_coexp_exp_int2_org_col_classified_apple_commit_full_clean.xlsx'
